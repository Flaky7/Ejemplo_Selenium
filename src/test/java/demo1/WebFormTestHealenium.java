...
public class WebFormTestHealenium {
    ...
    public void completarFormularioWeb() throws InterruptedException {
        ...
        // Simula que la pagina cambio el id (como si el desarrollador hubiera actualizado el HTML)
        ((org.openqa.selenium.JavascriptExecutor) driver)
                .executeScript("document.getElementById('my-check-2').id = 'my-check-999';");
        Thread.sleep(500);
